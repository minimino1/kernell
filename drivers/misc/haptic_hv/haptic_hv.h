...
#define AW_RT_GPP_MAX				(800)
#define AW_RT_GPP_MIN				(200)
#define AW_RT_F0_MAX				(1870)
#define AW_RT_F0_MIN				(1530)
#define AW_RT_R0_MAX				(10200)
#define AW_RT_R0_MIN				(5800)
...
#define AW8693X_LCC_ALGO
#define AW_LCC_DEFAULT_BST_9V		(9000)
 ...
 *
 *********************************************************/
enum aw_haptic_RT_sample_update_flag {
	AW_UPDATE_DISABLE = 0,
	AW_UPDATE_ENABLE = 1,
};
...
#ifdef AW8693X_LCC_ALGO
	uint16_t golden_param[6];
	uint16_t sample_param[6];
	uint16_t uefi_param[6];
	int32_t rtp_scale_coff[2];
	uint8_t RT_param_update_flag;
#endif
...
#endif
	int (*get_gpp)(struct aw_haptic *aw_haptic);
};
...
#ifdef AW8693X_LCC_ALGO
extern void aw_get_sample_params(struct aw_haptic *aw_haptic);
#endif
